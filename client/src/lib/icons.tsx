...
export function FractionIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <text x="7" y="8" fontSize="6" fontWeight="bold" fill="currentColor">
        1
      </text>
      <text x="7" y="18" fontSize="6" fontWeight="bold" fill="currentColor">
        2
      </text>
    </svg>
  );
...
export function DecimalIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function PercentageIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <text x="7" y="16" fontSize="10" fontWeight="bold" fill="currentColor">
        %
      </text>
    </svg>
  );
